 ...
 * |----------------------------------------------------------------------------------
 * | 2024-02-17  | Justin         | Wired up the home page
 */
?>
<html lang="en">
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        ...
                                        <div>Total Runners</div>
                                    </div>
                                </div>
                            </div>
                            <a href="<?php echo base_url('admin/manage_runners'); ?>">
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        ...
                                        <div>Active Races</div>
                                    </div>
                                </div>
                            </div>
                            <a href="<?php echo site_url('admin/manage_marathons'); ?>" class="btn btn-primary">Manage Marathons</a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
